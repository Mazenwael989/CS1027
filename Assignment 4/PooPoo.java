...
/**
 * joinTrees method completed by Mazen Baioumy
 */

//Takes the given root and sets the left sub tree to the left sub tree provided
root.setLeft(leftSubtree);

//Takes given root and sets the right sub tree to the right sub tree provided
...
//Recursive method which counts the number of nodes in a tree by counting the number of nodes.

/**
 * findHeight method completed by Mazen Baioumy
 */

//Counts recursively each node on the left side of the tree

int leftHeight = findHeight(node.getLeft());

//Counts recursively each node on the right side of the tree

int rightHeight = findHeight(node.getRight());

//If the height of the left side is greater than that of the right side return it plus one count for the root.
...
//Otherwise return the right height with plus one count for the root.
...
/**
 * countBinaryTreeNodes method completed by Mazen Baioumy
 */

//Scales recursively through the tree and count every node within it.
...
public static String inOrder(BinaryTreeNode<String> root,String stg)
{
	...
	{
	/**
	 * inOrder method completed by Mazen Baioumy
	 */
	
//Makes a string which uses recursion to go through the tree in an inorder fashion and concatenate into a single string
...
if(root!=null) 
  {
	/**
	 * preOrder method completed by Mazen Baioumy
	 */
	
//Makes a string which uses recursion to go through the tree in an preorder fashion and concatenate into a single string
...
if(root!=null) 
  {
	...
	/**
	 * postOrder method completed by Mazen Baioumy
	 */
	
	//Makes a string which uses recursion to go through the tree in an postorder fashion and concatenate into a single string
