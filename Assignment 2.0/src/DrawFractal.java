...
// Create a for loop with else if statments creating angles, and trying to define the drawings with appropriate lengths.
//this method takes the string representing the fractal and produces an array of line objects that draw the fractal.
for (int i = 0; i < fractalString.length(); i++) {
	String symbol = fractalString.substring(i, i+1);
